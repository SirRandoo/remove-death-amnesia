...
public class Settings : ModSettings
{
    ...
    public static void Draw(Rect canvas)
    {
        ...
        var pageRect = new Rect(menuRect.x + menuRect.width + 5f, 0f, canvas.width - menuRect.width - 5f, canvas.height);
    ...
    private static void DrawGeneralPage(Listing_Standard listing)
    {
        ...
        listing.CheckboxLabeled("RDA.Settings.General.MedicalCare".Translate(), ref MedicalCare, "RDA.Settings.General.MedicalCare.Tooltip".Translate());
        listing.CheckboxLabeled("RDA.Settings.General.HostilityResponse".Translate(), ref HostilityResponse, "RDA.Settings.General.HostilityResponse.Tooltip".Translate());
